...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--retrieval-test", action="store_true", help="Use /v1/api/chunk/retrieval_test")
...
def search(args: argparse.Namespace, *, base_url: str, api_key: str) -> dict[str, Any]:
    ...
    if args.retrieval_test:
        ...
        body["kb_id"] = kb_id
        api_endpoint = f"{base_url}/v1/api/chunk/retrieval_test"
    else:
        if dataset_ids:
            body["dataset_ids"] = dataset_ids
        api_endpoint = f"{base_url}/v1/api/retrieval"
