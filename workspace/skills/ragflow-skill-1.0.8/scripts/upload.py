...
def upload_documents(dataset_id: str, file_paths: list[str], *, base_url: str, api_key: str) -> dict[str, Any]:
    ...
    url = f"{base_url}/v1/api/datasets/{dataset_id}/documents"
...
def list_documents(
    ...
    *,
    ...
    payload = ensure_success(
        request_json(
            f"{base_url}/v1/api/datasets/{encoded_dataset_id}/documents?{query}",
            api_key,
        )
    )
...
def delete_documents(dataset_id: str, raw_ids: str, *, base_url: str, api_key: str) -> dict[str, Any]:
    ...
    payload = ensure_success(
        request_json(
            f"{base_url}/v1/api/datasets/{encoded_dataset_id}/documents",
            api_key,
            method="DELETE",
